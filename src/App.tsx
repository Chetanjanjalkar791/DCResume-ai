  ...
  projects: [
    {
      ...
      link: "github.com/alexrivera/smart-resume"
    }
  ],
  education: [
    {
...
export default function App() {
  ...
  return (
    <div className="min-h-screen text-slate-800 dark:text-slate-100 flex flex-col relative transition-colors print:bg-white print:text-black print:min-h-0 print:block">
      ...
      {/* ----------------- GLOBAL HEADER ----------------- */}
      <header className="sticky top-0 z-40 bg-[#080b13]/85 backdrop-blur-md border-b border-slate-850 px-6 py-3.5 print-hidden print:hidden">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          
          {/* Logo brand and navigation options */}
          <div className="flex items-center gap-6">
            ...
            >
              <div className="flex items-center gap-2">
                <img 
                  src={logoImg} 
                  className="w-8 h-8 object-contain select-none shrink-0 group-hover:scale-105 transition-transform" 
                  alt="DC Logo" 
                />
                <span className="bg-gradient-to-r from-purple-450 via-fuchsia-400 to-pink-400 text-transparent bg-clip-text text-lg font-black tracking-wider font-space select-none">
                  RESUME
                </span>
              </div>
            </div>
            ...
            <nav className="flex items-center gap-2 text-slate-400">
              <button 
                onClick={() => setActiveFlow("home")}
                className={`transition-all duration-200 text-[11px] font-sans ${
                  activeFlow === "home" 
                    ? "px-3.5 py-1.5 rounded-full text-purple-300 bg-purple-950/40 border border-purple-900/30 font-extrabold shadow-[0_0_15px_-3px_rgba(168,85,247,0.15)]" 
                    : "px-3.5 py-1.5 rounded-full text-slate-400 hover:text-white hover:bg-slate-900/60 font-bold"
                }`}
              >
                Home
              </button>
          ...
          <div className="flex items-center gap-3">
            {(activeFlow === "home" || activeFlow === "about") && (
              <button
                ...
                className="px-4 py-1.5 text-[11px] font-black text-white bg-gradient-to-r from-purple-600 to-pink-650 hover:from-purple-500 hover:to-pink-550 rounded-full shadow-md hover:shadow-purple-500/25 transition-all hover:scale-[1.03] active:scale-[0.98] duration-200 font-sans"
              >
                Start Free ⚡
              </button>
            )}
            ...
            {activeFlow === "select-flow" && (
              <button
                onClick={() => setActiveFlow("home")}
                className="px-3.5 py-1.5 text-[11px] font-bold text-slate-400 hover:text-white bg-slate-900/60 border border-slate-800 rounded-full hover:bg-slate-800 transition-colors font-sans"
              >
                Back to Home
              </button>
            )}
            ...
            {activeFlow === "dashboard" && (
              <button
                onClick={() => setActiveFlow("home")}
                className="hidden sm:flex items-center gap-1.5 px-3.5 py-1.5 text-[11px] font-bold text-slate-350 bg-slate-900 border border-slate-800 rounded-full hover:bg-slate-800 transition-colors font-sans"
              >
                <Undo2 size={12} />
        ...
        {activeFlow === "home" && (
          <div className="py-16 px-4 max-w-5xl mx-auto space-y-16">
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-4xl sm:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 text-transparent bg-clip-text max-w-3xl mx-auto leading-tight italic">
                Build Resumes That Actually Secure the Bag. 🚀
              </h3>
              <p className="text-sm text-slate-350 max-w-xl mx-auto font-sans leading-relaxed">
              ...
              <div className="pt-4 flex flex-col sm:flex-row justify-center items-center gap-4">
                <button
                  onClick={() => setActiveFlow("select-flow")}
                  className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-purple-600 via-fuchsia-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-black text-sm rounded-xl shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-[1.02] transition-all duration-300"
                >
                  Optimize Your Resume ⚡
                </button>
                <button
                  onClick={() => setActiveFlow("about")}
                  className="w-full sm:w-auto px-8 py-3.5 bg-transparent border border-slate-800 hover:bg-slate-900 hover:border-slate-700 text-slate-300 hover:text-white font-bold text-sm rounded-xl transition-all duration-300"
                >
                  Read The Blueprint
                </button>
              </div>
            ...
            {/* CSS Mockup of the Workspace */}
            <div className="relative mx-auto max-w-4xl bg-slate-950/80 rounded-2xl border border-slate-800 shadow-2xl p-4 sm:p-6 overflow-hidden">
              {/* Window Controls */}
                ...
                <div className="md:col-span-5 space-y-3 opacity-90">
                  ...
                  <div className="space-y-2.5">
                    <div className="space-y-1">
                      ...
                      <div className="h-7 bg-slate-900 border border-slate-800 rounded px-2 text-[10px] text-slate-200 flex items-center">Alex Rivera</div>
                    </div>
        ...
        {activeFlow === "about" && (
          <div className="py-12 px-4 max-w-4xl mx-auto space-y-12">
            ...
            <div className="text-center space-y-3">
              ...
              <h3 className="text-3xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-purple-500 via-pink-500 to-orange-450 text-transparent bg-clip-text max-w-2xl mx-auto leading-tight italic">
                About RESUME
              </h3>
              <p className="text-xs sm:text-sm text-slate-350 max-w-xl mx-auto font-sans leading-relaxed">
                A premium, client-side resume builder and ATS optimizer built to keep your data private and get you hired. Secure the bag, no cap.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              ...
              <div className="bg-[#090b11] border border-slate-800/60 p-6 rounded-2xl shadow-xl hover:shadow-[0_0_25px_-5px_rgba(168,85,247,0.25)] transition-shadow space-y-3">
                <div className="w-10 h-10 bg-purple-950/40 text-purple-450 rounded-xl flex items-center justify-center border border-purple-900/40">
                  <Database size={18} />
                </div>
                ...
                <div className="bg-[#090b11] border border-slate-800/60 border-t-2 border-t-pink-500 rounded-2xl p-6 space-y-4 relative shadow-2xl">
                  ...
                  <div className="space-y-3 pt-1">
                    ...
                    <div className="space-y-1 font-sans">
                      ...
                      <div className="h-1.5 w-full bg-slate-900 rounded-full overflow-hidden">
                        <div className="h-full rounded-full bg-gradient-to-r from-slate-450 to-slate-200" style={{ width: "85%" }} />
                      </div>
                    </div>
      ...
      {/* ----------------- GLOBAL FOOTER ----------------- */}
      <footer className="bg-slate-100/40 dark:bg-slate-950/30 border-t border-slate-200/60 dark:border-slate-900 py-6 text-center text-[11px] text-slate-500 print-hidden print:hidden shrink-0 mt-auto backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 space-y-1.5">
          <p className="font-medium text-slate-600 dark:text-slate-400">© 2026 AI Smart Resume Builder Engine. Zero cloud databases required, completely private and client persistent.</p>
          <div className="flex justify-center gap-4 text-[10px]">
            <span>No logins or cookies tracked</span>
            <span>•</span>
            <span>Optimized vector printable outputs for standard HR readers</span>
            <span>•</span>
            <span>Crafted over Cloud containers via Express API</span>
          </div>
        </div>
      </footer>
